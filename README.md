...
<p align="center">
  <img src="docs/device.jpg" alt="X836 pocket laptop running Kali Linux outdoors" width="640">
  <br>
  <sub><i>The actual unit — Kali boot in the garden. USB WiFi adapter visible on the right.</i></sub>
</p>
